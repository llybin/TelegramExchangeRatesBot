...
class RegexParserTest(unittest.TestCase):
    ...
    def test_bad(self, m):
        cases = [
            ...
            "BTC",
            "BTC > USD",
            "1234567890123 USD" "100000000000 USD",
        ]
...
class ParseAmountTest(unittest.TestCase):
    ...
    def test_ok(self, m):
        ...
        self.assertEqual(parse_amount("9", "en"), Decimal("9"))

        self.assertEqual(parse_amount("9 123", "en"), Decimal("9123"))

        self.assertEqual(parse_amount("9,123", "en"), Decimal("9123"))

        self.assertEqual(parse_amount("9,123", "de"), Decimal("9.123"))

        self.assertEqual(parse_amount("9,123", "ru"), Decimal("9.123"))

        self.assertEqual(parse_amount("9.123", "pt_BR"), Decimal("9123"))

        self.assertEqual(parse_amount("9.123", "zh_Hans_SG"), Decimal("9.123"))
