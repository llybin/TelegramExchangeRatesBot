...
def upgrade():
    ...
    op.alter_column('chats', 'money_format', nullable=False)
...
def downgrade():
    ...
    op.drop_column('chats', 'money_format')
    op.drop_column('chats', 'is_colored_arrows')
    op.drop_column('chats', 'default_currency_position')
    op.drop_column('chats', 'default_currency_id')
    # ### end Alembic commands ###
